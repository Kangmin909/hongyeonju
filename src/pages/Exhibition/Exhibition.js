        ...
        {filteredExhibitions.map((exhibition) => (
          <div className="exhibition-item" key={exhibition.id}>
            ...
            <div className="exhibition-info">
              ...
              <div className="exhibition-meta">{exhibition.meta}</div>
            </div>
          </div>
        ))}
      </div>
