      ...
      <div className="exhibition-detail-images">
        {exhibition.images.map((image) => (
          <div key={image.id} className="exhibition-detail-image-container">
            <img src={image.url} alt={image.label} className="exhibition-detail-image" />
          </div>
        ))}
      </div>
    </div>
