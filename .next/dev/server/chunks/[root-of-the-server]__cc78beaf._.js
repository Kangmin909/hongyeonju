...
"[project]/src/pages/api/getHome.js [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    try {
        ...
        console.error(err);
        res.status(500).json({
            error: "Failed to load home media"
        });
    }
}
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cc78beaf._.js.map